...
```bash
claude plugin tag adapters/claude-code     # creates airlock--v0.2.0, validates agreement
```
...
python3 -m build                 # -> dist/airlock_guard_core-0.2.0{.tar.gz,-py3-none-any.whl}
